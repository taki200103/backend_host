...
export declare class HouseholdController {
    ...
    constructor(service: HouseholdService);
    create(data: CreateHouseholdDto): import("@prisma/client").Prisma.Prisma__HouseholdClient<{
        id: string;
    ...
    update(id: string, data: UpdateHouseholdDto): import("@prisma/client").Prisma.Prisma__HouseholdClient<{
        id: string;
        contractStartDate: Date;
        contractEndDate: Date;
        ownerId: string;
